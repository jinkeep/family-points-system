  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <motion.header
        ...
        className={`bg-gradient-to-r ${getPersonColor()} text-white py-8 px-4 shadow-xl`}
      >
              ...
              <div className="flex items-center justify-around flex-wrap gap-6">
                ...
                >
                  ...
                  <motion.p
                    ...
                    className={`text-6xl font-bold bg-gradient-to-r ${getPersonColor()} bg-clip-text text-transparent`}
                  >
                    {totalPoints}
                  </motion.p>
                </motion.div>
