...
export function PersonClient({ name }: PersonClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        {/* 头部 */}
        <header className={`bg-gradient-to-r ${getPersonColor()} text-white py-8 px-4 shadow-xl animate-fade-in-down`}>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold flex items-center gap-3">
                    <span className="text-5xl animate-pulse-slow">{getPersonEmoji()}</span>
                    {name}的积分明细
                  </h1>
                </div>
              </div>
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
            ...
            <Card className="shadow-xl card-hover">
              <CardContent className="p-8">
                <div className="flex items-center justify-around flex-wrap gap-6">
                  <div className="text-center stat-card animate-scale-in" style={{ animationDelay: '0.3s' }}>
                    <Award className="w-12 h-12 text-yellow-500 mx-auto mb-2 animate-pulse-slow" />
                    <p className="text-gray-600 text-sm">当前总积分</p>
                    <p className={`text-6xl font-bold bg-gradient-to-r ${getPersonColor()} bg-clip-text text-transparent animate-count-up`} style={{ animationDelay: '0.5s' }}>
                      {totalPoints}
                    </p>
                  </div>

                  <div className="text-center stat-card animate-scale-in" style={{ animationDelay: '0.4s' }}>
                    <TrendingUp className="w-12 h-12 text-green-500 mx-auto mb-2" />
                    <p className="text-gray-600 text-sm">获得积分</p>
                    <p className="text-4xl font-bold text-green-600 animate-count-up" style={{ animationDelay: '0.6s' }}>+{totalPositive}</p>
                  </div>

                  <div className="text-center stat-card animate-scale-in" style={{ animationDelay: '0.5s' }}>
                    <TrendingDown className="w-12 h-12 text-red-500 mx-auto mb-2" />
                    <p className="text-gray-600 text-sm">扣除积分</p>
                    <p className="text-4xl font-bold text-red-600 animate-count-up" style={{ animationDelay: '0.7s' }}>{totalNegative}</p>
                  </div>

                  <div className="text-center stat-card animate-scale-in" style={{ animationDelay: '0.6s' }}>
                    <Target className="w-12 h-12 text-blue-500 mx-auto mb-2" />
                    <p className="text-gray-600 text-sm">平均积分/次</p>
                    <p className="text-4xl font-bold text-blue-600 animate-count-up" style={{ animationDelay: '0.8s' }}>{avgPoints.toFixed(1)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="animate-slide-in-left" style={{ animationDelay: '0.7s' }}>
              <Card className="shadow-lg h-full card-hover">
                <CardHeader>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="text-green-600 transition-all duration-300 hover:scale-105"
                    >
                      获得积分
                    </Button>
                    <Button
                      ...
                      className="text-red-600 transition-all duration-300 hover:scale-105"
                    >
                      扣除积分
                    </Button>
                  </div>
                ...
                <div className="space-y-3">
                  {filteredDetails.map((item, index) => (
                    <div
                      ...
                      className={`item-row flex items-center justify-between p-4 rounded-lg border-2 ${
                        item.points > 0
        ...
        {/* 页脚 */}
        <footer className="bg-gray-800 text-white py-6 px-4 mt-12 animate-fade-in-up" style={{ animationDelay: '1.5s' }}>
